    ...
    <main className="container">
      <header className="hero">
        <div className="hero-text">
          <span className="badge">오늘의 QR 메이커</span>
          <h1>
          ...
          <p className="description">
            URL, 텍스트, 연락처 정보를 귀엽고 선명한 QR 코드로 변환합니다.
          </p>
        </div>
      ...
      <div className="tabs" role="tablist" aria-label="QR 유형 선택">
      ...
      <section className="panel">
        {activeTab === "url" && (
          <label className="field">
            ...
            />
            <small>
              프로토콜(https://)이 없으면 자동으로 추가되어 안전한 URL로
              이동합니다.
            </small>
          </label>
        )}
      ...
      <footer className="footer">
        개발자 :{" "}
        <a className="footer-link" href="mailto:cybereunny@naver.com">
          은준욱
        </a>
      </footer>
    </main>
